...
fun JournalpostHendelse.erJournalstatusEndretTilIkkeMottatt() = hentStatus() != null && !erMottattStatus
...
val JournalpostHendelse.erJournalfort get() = hentStatus() == JournalpostStatus.JOURNALFØRT
