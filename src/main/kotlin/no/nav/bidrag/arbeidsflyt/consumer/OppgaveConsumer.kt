...
data class OppgaveSokResponse(var antallTreffTotalt: Int = 0, private var oppgaver: MutableList<OppgaveData> = ArrayList(antallTreffTotalt)) {
    fun leggTil(oppgaveSokResponse: OppgaveSokResponse?): OppgaveSokResponse {
        antallTreffTotalt += oppgaveSokResponse?.antallTreffTotalt ?: 0
        oppgaver.addAll(oppgaveSokResponse?.oppgaver ?: emptyList())
