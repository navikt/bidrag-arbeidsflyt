...
fun journalpostResponse(journalpostId: String = JOURNALPOST_ID_1, journalStatus: JournalpostStatus = JournalpostStatus.JOURNALFØRT, journalforendeEnhet: String = "4833", tema: String = "BID"): JournalpostResponse {
